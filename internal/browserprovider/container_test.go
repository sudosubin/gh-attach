...
func TestCookieGroupKey(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			cookies.ProfileSelector{},
			"default",
			libsweetcookie.Container{ID: 2, Name: "Work"},
			true,
		...
		},
		{
			...
			cookies.ProfileSelector{Profile: "anything"},
			"default",
			libsweetcookie.Container{},
			true,
			containerGroupKey{Profile: "default"},
		},
		{
			"container name match",
			cookies.ProfileSelector{Container: "Work"},
			"default",
			libsweetcookie.Container{ID: 2, Name: "Work"},
			true,
			containerGroupKey{Profile: "default", ContainerID: 2, ContainerName: "Work"},
		},
		{
			...
			cookies.ProfileSelector{Container: "Work"},
			"default",
			libsweetcookie.Container{ID: 2, Name: "Home"},
			false,
			containerGroupKey{},
		},
		{
			"container id match",
			cookies.ProfileSelector{Container: "2", MatchByID: true},
			"default",
			libsweetcookie.Container{ID: 2, Name: "Work"},
			true,
			containerGroupKey{Profile: "default", ContainerID: 2, ContainerName: "Work"},
